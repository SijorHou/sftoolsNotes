...
[csdn教程分章节](https://blog.csdn.net/m0_55993923/article/details/129718974)
...
***redis 是 k-v 键值对存储数据（在内存中），key都是 String，value 有不同的数据类型***
...
```
- 命令不区分大小写，但是 key 区分大小写
- `HELP @DataType` 会返回命令提示
